...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col p-6 bg-[#2D3186] relative">
      {/* Background Image */}
      <div className="absolute inset-0 -z-10">
        <Image
          src="/background-login.png" // Pastikan file ini ada di folder public
      ...
      <div className="flex flex-col justify-center items-center min-h-screen">
        <div className="w-full max-w-md bg-[#303477] border border-white border-opacity-20 rounded-lg p-6">
          <h1 className="text-2xl font-bold text-center text-white mb-6">Sign In User</h1>
