...
const RegisterPage = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-[#2D3186] relative">
      <div className="absolute inset-0 -z-10 bg-cover bg-center" style={{ backgroundImage: 'url("/background-login.png")' }}></div>

      {/* Background transparent border */}
      <div className="absolute inset-0 -z-20 bg-gray-500/50 rounded-2xl -m-6" style={{ boxShadow: '0 0 40px rgba(0, 0, 0, 0.2)' }}></div>
      ...
      {/* Card Form */}
      <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto bg-[#303477] rounded-2xl shadow-2xl p-8 z-10 relative">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 w-full">
          ...
          <div className="text-center text-sm text-white mt-4">
            Sudah punya akun? <Link href="/login" className="text-blue-600 font-medium hover:underline">Sign In</Link>
          </div>
