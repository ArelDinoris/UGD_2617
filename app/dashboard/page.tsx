            ...
            <div className="flex justify-center items-center min-h-screen">
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-1/2">
                        <div className="rounded-xl shadow-md overflow-hidden border-[15px] border-[#999999] mb-6 transition-transform duration-300 ease-in-out hover:scale-105 cursor-pointer">
                        ...
                        <div className="rounded-xl shadow-md overflow-hidden border-[15px] border-[#999999] transition-transform duration-300 ease-in-out hover:scale-105 cursor-pointer">
                            <button className="w-full py-4 text-2xl md:text-4xl bg-[#2D3186] text-white transition-all duration-300 font-semibold rounded-none hover:bg-[#1e2257]">
                                See More
                            </button>
                        </div>
                    ...
                    <div className="md:w-1/2 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="flex flex-col h-full">
                                <div className="bg-[#999999] rounded-xl p-4 flex-1 flex flex-col transition-transform duration-300 ease-in-out hover:scale-105 cursor-pointer">
                                    <div className="bg-[#2D3186] p-4 rounded-lg shadow-sm flex-1 flex flex-col transition-colors duration-300 hover:bg-[#1e2257]">
                            ...
                            {/* Commitment Box */}
                            <div className="flex flex-col h-full">
                                <div className="bg-[#999999] rounded-xl p-4 border border-[#999999] flex-1 flex flex-col transition-transform duration-300 ease-in-out hover:scale-105 cursor-pointer">
                                    <div className="bg-[#2D3186] p-4 rounded-lg shadow-sm flex-1 flex flex-col transition-colors duration-300 hover:bg-[#1e2257]">
                            ...
                            <div className="flex flex-col h-full">
                                <div className="bg-[#999999] rounded-xl p-4 border border-[#999999] flex-1 flex flex-col transition-transform duration-300 ease-in-out hover:scale-105 cursor-pointer">
                                    <div className="bg-[#2D3186] p-4 rounded-lg flex-1 flex flex-col transition-colors duration-300 hover:bg-[#1e2257]">
